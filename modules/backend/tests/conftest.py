...
from modules.backend.core.auth import create_access_token, get_password_hash
...
settings.DATABASE_URL = "postgresql+asyncpg://postgres:postgres@localhost:5432/zeblit_db_test"
