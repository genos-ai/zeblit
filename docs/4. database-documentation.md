...
export DATABASE_URL="postgresql://user:password@localhost/zeblit_db"
...
```bash
# Full backup
pg_dump -h localhost -U postgres -d zeblit_db > backup.sql

# Backup specific tables
pg_dump -h localhost -U postgres -d zeblit_db \
